...
export default async function Health() {
  ...
  const sources = [
    ...
    { name:"Supabase alerts", last:"now", status: supabaseOk?"on":"stub", hits: supabaseOk?">0 rows":"mock" },
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-8">
      ...
      <p className="mt-1 font-mono text-xs text-zinc-500">Vercel Cron → QStash 15m fallback • Supabase {supabaseOk?"true":"stub"} • Redis hit</p>
